...
contract FflonkVerifierWithMock {
    ...
    uint256 constant C0x =
        19531210301294568511992648735135291982401633864004026433715722115099857739632;
    uint256 constant C0y =
        16913517370715546973488219367119174715262034757907912789481968159710930517904;
    ...
    modifier onlyAdmin() {
        require(msg.sender == amdin, "Only admin can call this function");
        _;
    }

    function activateMockMode() public onlyAdmin {
        mockMode = true;
    }

    function deactivateMockMode() public onlyAdmin {
        mockMode = false;
    }
